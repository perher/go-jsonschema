...
func (j *AnyOf6Qux2Elem) UnmarshalYAML(value *yaml.Node) error {
	...
	var errs []error
	if err := value.Decode(&anyOf6Qux2Elem_0); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&anyOf6Qux2Elem_1); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&anyOf6Qux2Elem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
...
func (j *AnyOf6Qux2Elem) UnmarshalJSON(value []byte) error {
	...
	var anyOf6Qux2Elem_2 AnyOf6Qux2Elem_2
	var errs []error
	if err := json.Unmarshal(value, &anyOf6Qux2Elem_0); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &anyOf6Qux2Elem_1); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &anyOf6Qux2Elem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Bar2ContentElem) UnmarshalJSON(value []byte) error {
	...
	var errs []error
	if err := json.Unmarshal(value, &bar2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &bar2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &bar2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Bar2ContentElem) UnmarshalYAML(value *yaml.Node) error {
	...
	var bar2ContentElem_2 Bar2ContentElem_2
	var errs []error
	if err := value.Decode(&bar2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&bar2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&bar2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Baz2ContentElem) UnmarshalYAML(value *yaml.Node) error {
	...
	var errs []error
	if err := value.Decode(&baz2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&baz2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&baz2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Baz2ContentElem) UnmarshalJSON(value []byte) error {
	...
	var baz2ContentElem_2 Baz2ContentElem_2
	var errs []error
	if err := json.Unmarshal(value, &baz2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &baz2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &baz2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Foo2ContentElem) UnmarshalYAML(value *yaml.Node) error {
	...
	var errs []error
	if err := value.Decode(&foo2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&foo2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := value.Decode(&foo2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
...
func (j *Foo2ContentElem) UnmarshalJSON(value []byte) error {
	...
	var foo2ContentElem_2 Foo2ContentElem_2
	var errs []error
	if err := json.Unmarshal(value, &foo2ContentElem_0); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &foo2ContentElem_1); err != nil {
		errs = append(errs, err)
	}
	if err := json.Unmarshal(value, &foo2ContentElem_2); err != nil {
		errs = append(errs, err)
	}
	if len(errs) == 3 {
		return fmt.Errorf("all validators failed: %s", errors.Join(errs...))
